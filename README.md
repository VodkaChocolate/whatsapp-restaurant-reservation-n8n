...
- 🎙️ **Voice message support** — Customers can send voice notes; Whisper transcribes them automatically
...
- Voice branch: downloads media → transcribes via Whisper → feeds to agent
...
| `Status` | `Confirmed` / `Cancellation Confirmed` / `Updated` |
